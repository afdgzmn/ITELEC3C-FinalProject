                    ...
                    <form>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12 col-sm-6" style="margin-top:30px"> 
                                ...
                                <label for="yes" class="radioLeft" ><input type="radio" id="tuesday" name="schedule" value="Tuesday (09:00 AM - 11:00 AM)" style="margin-right:10px" checked>Tuesday (09:00 AM - 11:00 AM)</label>
                                <label for="no" class="radioLeft"><input type="radio" id="saturday" name="schedule" value="Thursday (09:00 AM - 11:00 AM)" style="margin-right:10px">Thursday (09:00 AM - 11:00 AM)</label>
