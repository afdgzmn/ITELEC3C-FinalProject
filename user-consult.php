    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0 wow fadeIn" data-wow-delay="0.1s">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="user-consult.php" class="nav-item nav-link active">Consult Now</a>
                <!--
                    ...
                    <div class="col-12 col-sm-6">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-lg-6 rounded bg-light" style="padding:20px; width:48%; margin-right:10px;">
                                ...
                                <button onclick="window.location.href='user-slot-Agustin.php'" class="btn btn-primary w-100 py-3" type="submit" style="margin-top:20px">Book Appointment</button>
                            </div>
                            ...
                            <div class="col-lg-6 rounded bg-light" style="padding:20px; width:48%; margin-right:10px;">
                                ...
                                <button onclick="window.location.href='user-slot-Yapjuangco.php'" class="btn btn-primary w-100 py-3" type="submit" style="margin-top:20px">Book Appointment</button>
                            </div>
                        </div>
                        ...
                        <div class="row g-3">
                            <div class="col-lg-6 rounded bg-light" style="padding:20px; width:48%; margin-right:10px;margin-top: 30px;">
                                ...
                                <button onclick="window.location.href='user-slot-Carpio.php'" class="btn btn-primary w-100 py-3" type="submit" style="margin-top:20px">Book Appointment</button>
                            </div>
                            ...
                            <div class="col-lg-6 rounded bg-light" style="padding:20px; width:48%; margin-right:10px; margin-top: 30px;">
                                ...
                                <button onclick="window.location.href='user-slot-Nido.php'" class="btn btn-primary w-100 py-3" type="submit" style="margin-top:20px">Book Appointment</button>
                            </div>
                        </div>
                        ...
                        <div class="row g-3">
                            <div class="col-lg-6 rounded bg-light" style="padding:20px; width:48%; margin-right:10px;margin-top: 30px;">
                                ...
                                <button onclick="window.location.href='user-slot-Paulino.php'" class="btn btn-primary w-100 py-3" type="submit" style="margin-top:20px">Book Appointment</button>
                            </div>
                            ...
                            <div class="col-lg-6 rounded bg-light" style="padding:20px; width:48%; margin-right:10px; margin-top: 30px;">
                                ...
                                <button onclick="window.location.href='user-slot-Santos.php'" class="btn btn-primary w-100 py-3" type="submit" style="margin-top:20px">Book Appointment</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-sm-6">
                        ...
                        <div class="row g-3">
                            <div class="col-lg-6 rounded bg-light" style="padding:20px; width:48%; margin-right:10px;">
                                ...
                                <button onclick="window.location.href='user-slot-Tamayo.php'" class="btn btn-primary w-100 py-3" type="submit" style="margin-top:20px">Book Appointment</button>
                            </div>
                            ...
                            <div class="col-lg-6 rounded bg-light" style="padding:20px; width:48%; margin-right:10px;">
                                ...
                                <button onclick="window.location.href='user-slot-Villacorta.php'" class="btn btn-primary w-100 py-3" type="submit" style="margin-top:20px">Book Appointment</button>
                            </div>
                        </div>
                        <div class="row g-3">
                            <div class="col-lg-6 rounded bg-light" style="padding:20px; width:48%; margin-right:10px; margin-top:30px;">
                                ...
                                <button onclick="window.location.href='user-slot-Piano.php'" class="btn btn-primary w-100 py-3" type="submit" style="margin-top:20px">Book Appointment</button>
                            </div>
                            ...
                            <div class="col-lg-6 rounded bg-light" style="padding:20px; width:48%; margin-right:10px; margin-top:30px;">
                                ...
                                <button onclick="window.location.href='user-slot-Salonga.php'" class="btn btn-primary w-100 py-3" type="submit" style="margin-top:20px">Book Appointment</button>
                            </div>
                        </div>
                    </div>
                </div>
